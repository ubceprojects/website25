            ...
            {email && (
                <a href={`mailto:${email}`} className="social-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="35" viewBox="0 0 38 35" fill="none">
                        <path
                            d="M6.75 29.1666C5.89062 29.1666 5.14844 28.8871 4.52344 28.328C3.92448 27.7447 3.625 27.052 3.625 26.2499V8.74992C3.625 7.94784 3.92448 7.26728 4.52344 6.70825C5.14844 6.12492 5.89062 5.83325 6.75 5.83325H31.75C32.6094 5.83325 33.3385 6.12492 33.9375 6.70825C34.5625 7.26728 34.875 7.94784 34.875 8.74992V26.2499C34.875 27.052 34.5625 27.7447 33.9375 28.328C33.3385 28.8871 32.6094 29.1666 31.75 29.1666H6.75ZM19.25 18.9583L31.75 11.6666V8.74992L19.25 16.0416L6.75 8.74992V11.6666L19.25 18.9583Z"
                            fill="white"
                        />
                    </svg>
                </a>
